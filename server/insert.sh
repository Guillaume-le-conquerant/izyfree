...
curl -XDELETE http://5.135.83.124/v1/freelance/id/2
curl -XDELETE http://5.135.83.124/v1/freelance/id/3
...
curl -XPOST -H "Content-type: application/json" -d '{"conditions":"En entreprise","email":"david@david.com","firstname":"David","id":2,"job":"Developpeur Python","localisation":"Villeneuve","mots":"papa?maman","name":"Dav","phone":"0658595657","tarif":"400/jour"}' http://5.135.83.124/v1/freelance/
curl -XPOST -H "Content-type: application/json" -d '{"conditions":"A distance","email":"truc@truc.com","firstname":"truc","id":3,"job":"Developpeur PHP","localisation":"Tourcoing","mots":"dev?php","name":"truc","phone":"0645789865","tarif":"200/jour"}' http://5.135.83.124/v1/freelance/
